...
public class BaseBoard {
    ...
    /**
     * Calculates the color of the square based on its rank and file taking the size
     * of the board into consideration. For the traditional 8x8 board, a1
     * (rank/file) square will be black and the right-most (from the white player's
    ...
    public Map<Color, Integer> score() {
        return pieces.entrySet()
                     .stream()
                     .collect(Collectors.toMap(e -> e.getKey(), this::colorScore, (l, r) -> l + r));
    }
